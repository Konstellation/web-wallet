...
<script>
    ...
    export default {
        ...
        beforeMount() {
            this.form = JSON.parse(sessionStorage.getItem('transferFromForm')) || this.form;
        },
        mounted() {
        ...
        methods: {
            ...
            onSubmit(e) {
                ...
                this.$refs.form.validate(valid => {
                    ...
                    sessionStorage.setItem('transferFromForm', JSON.stringify(this.form));
                    this.$store.dispatch('issue/setForm', this.form);
                    this.$router.push('/issues/transfer-from/confirm');
