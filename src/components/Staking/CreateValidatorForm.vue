<template>
    <k-card>
        <el-form
            ...
            :rules="rules"
            @submit="onSubmit">
            <el-form-item prop="moniker">
                <el-input
                    :value="get(validator, 'description.moniker')"
                    :placeholder="$t('staking.moniker')">
                </el-input>
            </el-form-item>
            <el-form-item prop="identity">
                <el-input
                    :value="get(validator, 'description.identity')"
                    :placeholder="$t('staking.identity')">
                </el-input>
            </el-form-item>
            <el-form-item prop="website">
                <el-input
                    :value="get(validator, 'description.website')"
                    :placeholder="$t('staking.website')">
                </el-input>
            </el-form-item>
            <el-form-item prop="details">
                <el-input
                    :value="get(validator, 'description.details')"
                    :placeholder="$t('staking.details')">
                </el-input>
            </el-form-item>
            <el-form-item prop="minSelfDelegation">
                <el-input
                    :value="get(validator, 'min_self_delegation')"
                    :placeholder="$t('staking.min_self_delegation')">
                </el-input>
            </el-form-item>
            <el-form-item prop="rate">
                <el-input
                    :value="get(validator, 'commission.commission_rates.rate')"
                    :placeholder="$t('staking.rate')">
                </el-input>
            </el-form-item>
            <el-form-item prop="max_rate">
                <el-input
                    :value="get(validator, 'commission.commission_rates.max_rate')"
                    :placeholder="$t('staking.max_rate')">
                </el-input>
            </el-form-item>
            <el-form-item prop="max_change_rate">
                <el-input
                    :value="get(validator, 'commission.commission_rates.max_change_rate')"
...
<script>
    ...
    export default {
        ...
        async mounted () {
            const {validator} = this.$route.params;
            this.$store.dispatch('staking/fetchValidator', validator);
        },
        methods: {
            get,
            selectValidator () {
